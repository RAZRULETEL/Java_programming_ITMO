...
public class Insert implements ObjectCommand, Serializable {
    ...
    public ResultDTO validate(String[] args) {
        if(args != null && (args.length == 1 || (args.length == 2 && args[1].equals("auto")))) {
    ...
    public ResultDTO execute(AbstractRouteCollection collection) {
        ...
        route = null;
        return sucess ? new StringDTO(true, "Объект " + collection.get(key) + " успешно добавлен") : new StringDTO(false, "Ошибка добавления объекта");
    }
