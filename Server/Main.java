...
public class Main {
    ...
    private static final int CACHED_THREADS_COUNT = 1;
    private static final int SENDER_THREADS_COUNT = 1;
...
//    private static final String databaseName = "studs";
    ...
    private static final String serverCMPLogin = "admin", serverCMPPassword = "admin";
    ...
    public static void main(String[] args){
        ...
        try {
            dbCollection = new MyDBCollection(databaseHostPort+"/"+databaseName, dbLogin, dbPassword, server);
        } catch (SQLException | NoSuchFieldException e) {
            LOGGER.error("Cannot connect to DB, can't continue working without it, stopping app");
            System.exit(1);
        }
        ServerCommandProcessor mainProcessor = new ServerCommandProcessor(new DBCollectionAdapter(dbCollection, serverCMPLogin, serverCMPPassword));
